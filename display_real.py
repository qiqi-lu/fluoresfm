...
params = {
    ...
    # "path_dataset_raw": "E:\qiqilu\datasets\BioSR\\transformed\MTs\\test\channel_0\wf_noise_level_9",
    # "path_dataset_gt": "E:\qiqilu\datasets\BioSR\\transformed\MTs\\test\channel_0\sim",
    # "path_index_file": "E:\qiqilu\datasets\BioSR\\transformed\MTs\\test.txt",
    "path_dataset_gt": "E:\qiqilu\datasets\RCAN3D\\transformed\C2S_MT\\test\channel_0\STED",
    "dataset_name": "Real_C2S_MT",
    "path_dataset_raw": "E:\qiqilu\datasets\RCAN3D\\transformed\C2S_MT\\test\channel_0\confocal",
...
norm = utils_data.NormalizePercentile(p_low=0.0, p_high=0.999)
...
for idx in range(num_data):
    ...
    img_gt = utils_data.read_image(
        os.path.join(params["path_dataset_gt"], filenames[idx])
    )
    ...
    img_raw = utils_data.read_image(
        os.path.join(params["path_dataset_raw"], filenames[idx])
    )

    if len(img_raw.shape) == 2:
        img_raw = img_raw[None]

    img_raw = utils_data.interpx(img_raw, shape=img_gt.shape)
