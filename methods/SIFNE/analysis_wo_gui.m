...
save(fullfile(path_data,'imgpath.mat'), 'imgpath');
...
% orientation filter transform (LFT and OFT). The user shold define the
...
% Here, a mask drawn using ImageJ can be used.
...
%% Segmentation
% automatically calculate the threshold for binarizing the nehanced image
...
% the seach angle and radius can be automatically set as above
...
saveas(figure(1),fullfile(path_result,'Distribution_Junctions.fig'));
saveas(figure(2),fullfile(path_result,'Distribution_Junctions_Analysis.fig'));
